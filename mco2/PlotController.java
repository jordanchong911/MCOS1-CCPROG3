        ...
        if (butName.equals("Plot")) {
            ...
            if(seed != null)
                if(seed.getHarvestTime() == 0 && seed.isWithered() == false){
                    plotGui.getOptionPanel().setLayout(new GridLayout(8, 1, 2, 5));
                    plotGui.getOptionPanel().add(harvest);
                    plotGui.setVisible(true);
                }
                else if(seed.isWithered() == true){
                    plotGui.getOptionPanel().remove(harvest);
                    plotGui.getOptionPanel().setVisible(false);
                    plotGui.getOptionPanel().setLayout(new GridLayout(7, 1, 2, 5));
                }
        }
