...
public class ShopController implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // level up 
            ...
            String result = gui.getFarmer().nextLevel(titleShopModel.getTitles());
        ...
        // next day
            ...
            gui.getFarmer().NextDay(titleShopModel.getTitles(), seedShopModel.getSeed(), ToolShopModel.getTools());
            //change gui here
            if(gui.getFarmer().isGameOver() == true){
