...
public class PlotMenuGui extends JFrame {
    ...
    public void init(){
        ...
        //center 
        optionPanel = new JPanel(new GridLayout(7, 1, 2, 5));
    ...
    public void Harvest(String name, String quantity, String total){
        JOptionPane.showConfirmDialog(null, name + " has been successfully harvested\n" + quantity + " pieces were harvested\nTotal " + total, "Harves Success",JOptionPane.CLOSED_OPTION);
    }
